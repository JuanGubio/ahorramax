    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/20 via-secondary/10 to-accent/20 flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md p-8 bg-card/95 backdrop-blur-sm border-2">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Inicia sesión para continuar ahorrando</p>
        </div>
        ...
        {!showForgotPassword ? (
          ...
          <div className="space-y-5">
            <div className="text-center mb-4">
              <h2 className="text-xl font-bold text-foreground mb-2">Recuperar Contraseña</h2>
            ...
            <form onSubmit={handleForgotPassword} className="space-y-5">
              <div className="space-y-2">
                <Label htmlFor="reset-email" className="font-bold text-foreground">
                  Correo Electrónico
                </Label>
                <div className="relative">
                  <Mail className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground" />
